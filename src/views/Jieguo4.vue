          ...
          <div>
            ...
            <div class="integral-box" v-if="!scaleBo">
                <div class="img-box"   ref="canvasImg" :style="{'display': imgLoadBo?'block':'none'}">
                  <p class="name">{{name}}</p><span class="cause">单身的原因是</span>
                  <img class="img1" crossorigin="anonymous" :src="url" alt @load="imgLoad()" />
                     <!-- <img crossorigin="anonymous" class="code" src="http://yixiu.test.upcdn.net/banner/10002/code.jpg" /> -->
                  <div class="he">
                    <img crossorigin="anonymous" class="code" src="../assets/img/rwm.png" />
                    <div class="seave">
                      <p>长按识别二维码</p>
                      <p>测你单身的原因</p>
                    </div>
...
export default class Jieguo2 extends Mixins(MixinUtil) {
  ...
  get url() {
    return `//yxxl.net.cn/banner/10002/${+this.integral -2}.jpg`;
  }
  ...
  data(){
    ...
    let himgsrc="//yxxl.net.cn/banner/10002/"+num+".png"
    return{
      himgsrc
    }
  }
