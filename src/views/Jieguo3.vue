          ...
          <div>
            <div class="integral-box" v-if="!scaleBo">
                <div class="img-box" :style="{'display': imgLoadBo?'block':'none'}" ref="canvasImg">
                  ...
                  <img crossorigin="anonymous" class="code" src="//yxxl.net.cn/banner/10001/code.jpg" />
...
export default class Jieguo2 extends Mixins(MixinUtil) {
  ...
  get url() {
    return `//yxxl.net.cn/banner/10001/${+this.integral - 2}.jpg`;
  }
  ...
  data(){
    ...
    let himgsrc="//yxxl.net.cn/banner/10001/"+num+".png"
    return{
      himgsrc
    }
  }
